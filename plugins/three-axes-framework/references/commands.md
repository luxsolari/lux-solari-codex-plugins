...
| `/three-axes-log [note]` | `three-axes log [note]` | Append to `JOURNAL.md` at the repository root, newest first; compact past ~40 entries without dropping a decision or a recorded failure. |
